                                    ...
                                    {farmers.map((farmer) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-5 py-4">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    {farmer.profileImage ? (
                                                        ...
                                                        <div className="w-10 h-10 rounded-full bg-green-50 text-green-600 flex items-center justify-center font-semibold">
                                                            {farmer.name
                                                                ?.charAt(0)
                                                                ?.toUpperCase()}
                                                        </div>
                                            ...
                                            <td className="px-5 py-4">
                                                ...
                                                <p className="text-xs text-gray-500 mt-1 max-w-52 truncate">
                                                    {farmer.farmAddress}
                                                </p>
                                    ...
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <div className="flex items-center gap-3 min-w-0">
                                            ...
                                            {farmer.profileImage ? (
                                                ...
                                                <div className="w-11 h-11 rounded-full bg-green-50 text-green-600 flex items-center justify-center font-semibold shrink-0">
                                                    {farmer.name
                                                        ?.charAt(0)
                                                        ?.toUpperCase()}
                                                </div>
