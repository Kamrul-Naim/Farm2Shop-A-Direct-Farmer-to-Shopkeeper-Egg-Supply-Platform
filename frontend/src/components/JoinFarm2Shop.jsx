        ...
        <div className="relative mx-4 sm:mx-6 lg:mx-10 xl:mx-14">
          ...
          >
            ...
            <h2 className="mt-5 text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-tight">
              ...
              <span className="text-[#F4A62A]"> better connection?</span>
            </h2>

            {/* Description */}

            <p className="mt-5 text-sm sm:text-base text-white/70 leading-7 max-w-2xl mx-auto">
              Whether you are an egg farmer looking for reliable buyers or a
              shopkeeper looking for quality eggs, Farm2Shop brings both sides
              closer together.
            </p>
          </motion.div>
          ...
          <div className="mt-12 grid sm:grid-cols-2 gap-5 max-w-3xl mx-auto">
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span className="w-7">
                  <img src={assets.egg} alt="egg logo" />
                </span>
              </div>
              ...
              <p className="mt-2 text-sm text-gray-500 leading-6">
                Connect with verified shopkeepers and get your eggs into the
                market through a more organized selling process.
              </p>
              ...
              <motion.button
                ...
                className="mt-6 w-full flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#176B3A] text-white text-sm font-medium hover:bg-[#12572F] transition-all duration-300 cursor-pointer"
                onClick={() => {
                  setRole("farmer");
                  navigate("/register");
                }}
            ...
            >
              ...
              <p className="mt-2 text-sm text-gray-500 leading-6">
                Browse quality-verified eggs, place orders easily and receive
                your supply through our own delivery team.
              </p>
              ...
              <motion.button
                ...
                className="mt-6 w-full flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#F4A62A] text-[#123B27] text-sm font-semibold hover:bg-[#E99A1E] transition-all duration-300 cursor-pointer"
                onClick={() => {
                  setRole("shopkeeper");
                  navigate("/register");
                }}
          ...
          >
            ...
            <button className="inline-flex items-center gap-1.5 text-[#F4A62A] font-medium hover:text-white transition-colors cursor-pointer"
                onClick={() => {
                  navigate("/login");
                }}
            >
