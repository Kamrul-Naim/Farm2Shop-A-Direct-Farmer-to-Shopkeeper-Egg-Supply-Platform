                ...
                {orders.length === 0 ? (
                    <div className="bg-white rounded-2xl border border-gray-200 py-16 px-6 text-center">
                        ...
                        <button
                            ...
                            className="mt-6 px-5 py-2.5 rounded-xl bg-[#176B3A] text-white text-sm font-semibold hover:bg-[#12582f] transition"
                        >
                            Browse Marketplace
                        </button>
                    </div>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="mt-2 flex flex-wrap gap-x-5 gap-y-1 text-sm text-gray-500">
                                            ...
                                            <span>
                                                Payment:{" "}
                                                <span
                                                    className={`font-medium capitalize ${getPaymentClass(
                                                        order.paymentStatus
                                                    )}`}
                                                >
                                                    {order.paymentStatus}
